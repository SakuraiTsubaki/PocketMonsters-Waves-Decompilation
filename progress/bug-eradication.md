...
- Target repository: `SakuraiTsubaki/PocketMonsters-Waves-Decompilation`
- Public target: Pokémon Waves
...
7. check the corresponding Winds subsystem for shared-root defects.
