# Milestones: Pocket Monsters Waves

This roadmap governs research, tooling, analysis, reconstruction, and preservation for `SakuraiTsubaki/PocketMonsters-Waves-Decompilation`.
...
## U0 — Scope and exact target identity
...
## U1 — Reproducible structural inventory

**Goal:** produce a deterministic, reviewable map of the target before interpretation.

**Required outputs**

- Primary-source identity dossier, provenance record, candidate platform evidence, file signatures, hashes, and an explicit list of unresolved claims. No platform-specific parser is accepted before the target is established.
...
## U2 — Executable and symbol map

**Goal:** turn executable regions into a navigable evidence-backed code map.

**Required outputs**

- Only after target classification: executable/container map, architecture evidence, load model, symbols, references, and confidence records appropriate to the proven platform.
...
## U3 — Resource formats and asset pipelines

**Goal:** document and reproduce the target's non-code data formats.

**Required outputs**

- Only after format evidence exists: resource inventories, schemas, converters, manifests, and viewable PNG previews for every graphics or sprite workflow.
...
## U4 — Reviewed reconstruction slices
...
## U5 — Integrated reproducible workflow
...
## U6 — Evidence-backed research release
...
Do not infer platform, generation, release status, or relationship from the repository name; establish all identity claims from primary evidence.
