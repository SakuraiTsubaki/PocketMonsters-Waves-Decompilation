# Public Source Census — Pocket Monsters Waves

**Research baseline date:** 2026-09-14

This document records the pre-release public-source census for **Pocket Monsters Waves**. No retail game image, executable, package, build, or decrypted game data is available to this project at this stage.
...
- Japanese title: **『ポケットモンスター ウェーブ』**; paired title: **『ポケットモンスター ウインド』**.
